...
if ( ! class_exists( 'GACWP_Frontend_Ajax' ) ) {

	final class GACWP_Frontend_Ajax {
		...
		public function ajax_item_reports() {
			...
			if ( ! GACWP_Tools::check_roles( $this->gacwp->config->options['access_front'] ) || 0 == $this->gacwp->config->options['frontend_item_reports'] ) {
				wp_die( - 31 );
			}
