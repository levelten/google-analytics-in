 ...
 * with the `Deconfc_Logger_Psr::setLogger()` method.
 */
class Deconfc_Logger_Psr extends Deconfc_Logger_Abstract
{
  /**
   ...
   */
  public function __construct(Deconfc_Client $client, /*Psr\Log\LoggerInterface*/ $logger = null)
  {
