 ...
 */
class Deconfc_Cache_Memcache extends Deconfc_Cache_Abstract
{
  ...
  public function __construct(Deconfc_Client $client)
  {
    if (!function_exists('memcache_connect') && !class_exists("Memcached")) {
      ...
      throw new Deconfc_Cache_Exception($error);
    }
   ...
   * @param string $key
   * @param string $value
   * @throws Deconfc_Cache_Exception
   */
  public function set($key, $value)
  {
    ...
    if ($rc == false) {
      ...
      throw new Deconfc_Cache_Exception("Couldn't store data in cache");
    }
