...
class Deconfc_Config
{
  ...
  /**
   * Create a new Deconfc_Config. Can accept an ini file location with the
  ...
  public function __construct($ini_file_location = null)
  {
    $this->configuration = array(
      ...
      'auth_class'    => 'Deconfc_Auth_OAuth2',
      'io_class'      => self::USE_AUTO_IO_SELECTION,
      'cache_class'   => 'Deconfc_Cache_File',
      'logger_class'  => 'Deconfc_Logger_Null',
      ...
      'classes' => array(
        'Deconfc_IO_Abstract' => array(
          'request_timeout_seconds' => 100,
        ),
        'Deconfc_IO_Curl' => array(
          'disable_proxy_workaround' => false,
          'options' => null,
        ),
        'Deconfc_Logger_Abstract' => array(
          'level' => 'debug',
          'log_format' => "[%datetime%] %level%: %message% %context%\n",
          'date_format' => 'd/M/Y:H:i:s O',
          'allow_newlines' => true
        ),
        'Deconfc_Logger_File' => array(
          'file' => 'php://stdout',
          'mode' => 0640,
          'lock' => false,
        ),
        'Deconfc_Http_Request' => array(
        ...
        'Deconfc_Service_Exception' => array(
          'retry_map' => array(
        ...
        'Deconfc_Cache_File' => array(
          'directory' => sys_get_temp_dir() . '/Deconfc_Client'
        )
      ),
    );
   ...
   * the hd values within an id token (@see Deconfc_Auth_LoginTicket) after sign
